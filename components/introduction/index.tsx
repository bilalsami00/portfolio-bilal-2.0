...
const btn2Icon = resolveFontAwesomeIcon("fas", introSection.btn2.fontAwesome);
      ...
      <div className="lg:basis-1/2  md:basis-none sm:basis-full">
       ...
       `}
            ...
            >
              ...
              {btn1Icon && (
                <FontAwesomeIcon className="ml-3 w-[16px]" icon={btn1Icon} />
              )}
            </Button>
          )}
          ...
          {introSection.btn2.display && (
            <Button className="ml-5 uppercase flex justify-center items-center">
              ...
              {btn2Icon && (
                <FontAwesomeIcon className="ml-3 w-[16px]" icon={btn2Icon} />
              )}
            </Button>
          )}
        </div>
